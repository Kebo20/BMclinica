<table id="IdTblLote" border="1" bordercolor="#cccccc" >
    <thead>
    ...
    <tbody id="TbodyLote" style="font-size:12px;"> </tbody>  	
</table>
...
<!--    <div class="col-lg-4 col-md-12">
    ...
    <div class="col-lg-5 col-md-12">
        <input type="text" class="form-control" onkeyup="LisLote()" placeholder="Buscar Familia" id="TxtBuscarLote" >
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <table  width="100%" style="font-size:13px; font-weight:bold;">
                    ...
                    <tr>
                        <td><b>Nombre</b>
                            <input name ="nombre" type="text" id="nombre"  class="form-control" value="" autocomplete="off"></td>
                    </tr>
...
//        });
        $('#IdTblLote').fixheadertable({
            //caption	: 'Lista de Areas', 
            colratio: [15, 40,40,40],
            height: 500,
            width: '100%',
            zebra: true,
            sortable: false,
...
//
    function LisLote() {
        var $buscar = $("#TxtBuscarLote").val()
        $.post('controlador/Cfarmacia.php', {accion: "LIS_LOTE", buscar: $buscar}, function (data) {
            $("#TbodyLote").html(data);
            $("#IdFilaLote").val(0);
        })
    }
