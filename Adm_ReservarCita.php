...
//$listar=$ocaja->ListarCajaFondo($cod_ingreso);
//$col=$listar->fetch();
//$fondo_inicial=$col[1];$efectivo=$col[2];$tarjeta=$col[3];$egreso=$col[4];
   ...
   <div class="col-10 topi">
    ...
    <div class="modal-body" style="margin:0px !important">
      <table  width="100%">
        <tbody>
           <tr>
             <td  style="display:none"><b>FONDO INICIAL</b>
                 <input type="text" id="TxtIdFondoInicial" class="form-control" style="width:100%;" readonly="readonly" value='0.00' ></td></tr>
            <tr> <td ><b>Total Efectivo</b>
                 <input type="text" id="TxtIdEfectivo" class="form-control"  style="width:100%;" readonly="readonly" value="<?=$efectivo?>" ></td> </tr>
            <tr> <td ><b>Total Tarjeta</b>
                  <input type="text" id="TxtIdTarjeta"  class="form-control" style="width:100%" readonly="readonly" value="<?=$tarjeta?>"></td></tr>
             <tr><td ><b>Total Egresos</b>
                  <input type="text" id="TxtIdEgresos"  class="form-control" style="width:100%" readonly="readonly" value="<?=$egreso?>" ></td></tr>
             <tr><td ><b>Total Cierre</b>
                  <input type="text" id="TxtIdTotal" class="form-control" style="width:100%; font-size:16px; font-weight:bold" readonly="readonly"
						 value="<?=$total?>"></td> 
             </tr>
           <tr><td>&nbsp;</td></tr>
        </tbody>
    ...
    <div class="modal-footer" style="margin-top:-25px;">
        <table width="100%">
           <tr>
             <td align="left">
                <button class="btn bg-vino cambio-color mr-1 mb-1"  id="id_grabar" onclick="CerrarCaja()" >
                Cerrar Caja</button>
             </td>
           </tr>
        </table>
...
<script> 
  ...
  if (willDelete) { 
     $.post('controlador/Ccaja.php',{accion:"CERRAR",efectivo:$efectivo,tarjeta:$tarjeta,egresos:$egresos,total:$total},function(data){ 
	   if(data==1){$("#IdCuerpo").html('');swal("Se Cerro caja Correctamente", "Felicitaciones", "success");return false;}  
